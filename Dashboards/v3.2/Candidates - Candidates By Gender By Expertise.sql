-- Candidates - Candidates By Gender By Expertise.sql
-- 20150507
-- Count total candidates by "Gender" and by "Expertise"  (pivot)
SET NOCOUNT ON;
...
(
	SELECT
		RIT_G.nvcTranslation as Gender, RIT_R.nvcTranslation as Expertise, COUNT(*) as Num
	FROM
		dtlCandidate C
	JOIN
